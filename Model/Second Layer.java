    ...
    public static void main(String[] args) throws  Exception {
       ...
       KFoldIterator kf = new KFoldIterator(k, allData);
        for (int i = 0; i < k; i++) {
			...
			.layer(0, new DenseLayer.Builder().nIn(Inputs).nOut(81).build())
			.layer(1, new DenseLayer.Builder().nIn(81).nOut(77).build())
			.layer(2, new DenseLayer.Builder().nIn(77).nOut(55).build())
			.layer(3, new DenseLayer.Builder().nIn(55).nOut(33).activation(Activation.SIGMOID).build())
			.layer(4, new DenseLayer.Builder().nIn(33).nOut(17).build())
			.layer(5, new DenseLayer.Builder().nIn(17).nOut(6).build())
			.layer(6, new OutputLayer.Builder().nIn(6).nOut(outputs)
